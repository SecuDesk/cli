...
import { OperatingSystem, osMap } from "@secudesk/core/models/operating-system";
import { AwsCredentialsPlugin } from "@secudesk/core/plugin-sdk/aws-credentials-plugin";
