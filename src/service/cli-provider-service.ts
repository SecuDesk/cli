import { CloudProviderService } from "@secudesk/core/services/cloud-provider-service";
import { AwsIamUserService } from "@secudesk/core/services/session/aws/aws-iam-user-service";
import { FileService } from "@secudesk/core/services/file-service";
import { AwsCoreService } from "@secudesk/core/services/aws-core-service";
import { LogService } from "@secudesk/core/services/log-service";
import { TimerService } from "@secudesk/core/services/timer-service";
import { AwsIamRoleFederatedService } from "@secudesk/core/services/session/aws/aws-iam-role-federated-service";
import { AzureSessionService } from "@secudesk/core/services/session/azure/azure-session-service";
import { ExecuteService } from "@secudesk/core/services/execute-service";
import { RetroCompatibilityService } from "@secudesk/core/services/retro-compatibility-service";
import { AwsParentSessionFactory } from "@secudesk/core/services/session/aws/aws-parent-session.factory";
import { AwsIamRoleChainedService } from "@secudesk/core/services/session/aws/aws-iam-role-chained-service";
import { Repository } from "@secudesk/core/services/repository";
import { RegionsService } from "@secudesk/core/services/regions-service";
import { AwsSsoRoleService } from "@secudesk/core/services/session/aws/aws-sso-role-service";
import { BehaviouralSubjectService } from "@secudesk/core/services/behavioural-subject-service";
import { SessionFactory } from "@secudesk/core/services/session-factory";
import { RotationService } from "@secudesk/core/services/rotation-service";
import { AzureCoreService } from "@secudesk/core/services/azure-core-service";
...
import { constants } from "@secudesk/core/models/constants";
import { NamedProfilesService } from "@secudesk/core/services/named-profiles-service";
import { IdpUrlsService } from "@secudesk/core/services/idp-urls-service";
import { AwsSsoIntegrationService } from "@secudesk/core/services/integration/aws-sso-integration-service";
import CliInquirer from "inquirer";
import { AwsSsoOidcService } from "@secudesk/core/services/aws-sso-oidc.service";
import { CliOpenWebConsoleService } from "./cli-open-web-console-service";
import { WebConsoleService } from "@secudesk/core/services/web-console-service";
import { AwsSamlAssertionExtractionService } from "@secudesk/core/services/aws-saml-assertion-extraction-service";
import { SsmService } from "@secudesk/core/services/ssm-service";
...
import { SessionManagementService } from "@secudesk/core/services/session-management-service";
import { SegmentService } from "@secudesk/core/services/segment-service";
import { WorkspaceService } from "@secudesk/core/services/workspace-service";
import { CliNativeLoggerService } from "./cli-native-logger-service";
import { AzurePersistenceService } from "@secudesk/core/services/azure-persistence-service";
import { PluginManagerService } from "@secudesk/core/plugin-sdk/plugin-manager-service";
import { EnvironmentType, PluginEnvironment } from "@secudesk/core/plugin-sdk/plugin-environment";
import { IntegrationFactory } from "@secudesk/core/services/integration-factory";
import { AzureIntegrationService } from "@secudesk/core/services/integration/azure-integration-service";
...
import { WorkspaceConsistencyService } from "@secudesk/core/services/workspace-consistency-service";
import * as crypto from "crypto";
import { TeamService } from "./team-service";
import { LocalstackSessionService } from "@secudesk/core/services/session/localstack/localstack-session-service";
